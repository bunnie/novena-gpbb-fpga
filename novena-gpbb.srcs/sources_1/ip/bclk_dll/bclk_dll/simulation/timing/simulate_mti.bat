...
vlog -work work bclk_dll_tb.v

REM run the simulation
vsim -c -t ps +transport_int_delays -voptargs="+acc" -L secureip -L simprims_ver -sdfmax bclk_dll_tb\dut=..\..\implement\results\routed.sdf +no_notifier work.bclk_dll_tb work.glbl
